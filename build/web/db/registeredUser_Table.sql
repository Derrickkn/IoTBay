...
INSERT INTO RegisteredUser_Table (UserID, Password, PaymentMethod, Payment, SavedAddress, Activated)
    VALUES (1,'yS2EgwWF','Mastercard','5109026761021066','QLD, Almaden, 4 Glen William Road',TRUE),
            (2,'3GdRehE7','Visa','4532100337595190','WA, Deepdale, 98 Carnegie Avenue',TRUE),
            (3,'7XuBgqK8','Mastercard','5110897205095354','VIC, Macleod West, 25 Maintongoon Road',TRUE),
            (4,'8Wr1nkPU','American Express','378768396947117','NSW, Maragale, 56 Grayson Street',TRUE),
            (5,'6PhJ547G','Visa','4556107230680590','SA, Caralue, 56 Black Point Drive',FALSE),
            (6,'kT080yqB','Mastercard','5103702271607901','WA, Cramphone, 9 Cubbine Road',TRUE),
            (7,'h0Gmo5FE','American Express','372322837989597','NSW, Nerrigundah, 52 Mackie Street',TRUE),
            (8,'F8bn652c','Visa','4123107230680590','NT, Santa Teresa, 89 Yulara Drive',TRUE),
            (9,'V9v03Zjo','American Express','345585760490478','NSW, Cattai, 46 Cambridge Street',FALSE),
            (10,'q0T7x3hp','Mastercard','5112687226787818','VIC, Corindhap, 9 Sunraysia Road',TRUE),
            (11,'i2B3PI5R','American Express','378426225795062','NSW, Weelong, 64 Tooraweenah Road',TRUE),
            (12,'N0vSFH16','Visa','4123107111680590','NSW, Neath, 9 Woerdens Road',TRUE),
            ...
            (20,'7Mr6SvWZ','Mastercard','5102699185109613','NSW, Farley, 66 Elgin Street',TRUE);
