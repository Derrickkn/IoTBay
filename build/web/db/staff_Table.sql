...
VALUES  (21,'Ux5MOah1','Archer (0246995987)','Manager'),
        (22,'0dBsy8M7','Abigail (0889736546)','Manager'),
        (23,'Z2mzf2xy','Patrick (0353993462)','Manager'),
        (24,'b1ZFh6fL','Alex (0362610702)','Employee'),
        (25,'Au1WzkFp','Connor (0362463884)','Employee'),
        (26,'Lq8mXMFx','Darcy (0391979814)','Employee'),
        (27,'zK8pi7q5','Keira (0745116609)','Employee'),
        (28,'L8hKkR7X','Daniel (0249572032)','Employee'),
        (29,'p6HVJjIY','Darcy (0890539084)','Employee'),
        (30,'L1ftfAG1','Claudia (0353659891)','Employee'),
        (31,'vE1UXbdf','Indiana (0890436383)','Employee'),
        (32,'Vs78Aixv','Phoebe (0893814181)','Employee'),
        (33,'Wb91I533','Logan (0240490219)','Employee'),
        (34,'He45w0YB','Ali (0261608103)','Employee'),
        (35,'Mn9XzKy9','Aaron (0739197233)','Employee'),
        (36,'4oVZ9U45','Laura (0740032518)','Employee'),
        (37,'p3FXNi2Z','Zac (0240685285)','Employee'),
        (38,'E3frjFA4','Lilly (0740184410)','Employee'),
        (39,'7JeYVmC7','Connor (0261723424)','Employee'),
        (40,'2BaYFL61','Angus (0240133669)','Employee');
