<%-- 
    Document   : usercreate
    Created on : 08/06/2020, 5:29:22 PM
    Author     : luke.galic
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <tr><td>User Type</td>
                        <td>
                            ...
                            <select name="userType" id="userType">
                                <option value="Registered" <% if (userType.equals("R")) { %> selected <% } %>>Registered</option>
                                <option value="Unregistered" <% if (userType.equals("U")) { %> selected <% } %> >Unregistered</option>
                                <option value="Staff" <% if (userType.equals("S")) { %> selected <% } %> >Staff</option>
                            </select>
                        </td></tr>
            ...
            <a class="button" href="usermanage.jsp">Cancel</a>  
        </div>
    </body>
</html>