...
public class UserDao {
    ...
    //Start of DERRICK's Method
    
    //Adds a user to the users database. Used in registerservlet whenever a user registers to an account.
    public void addRegisteredUser(String email, String password, String mobile, String firstName, String lastName) throws SQLException {
        ...
        //Get highest userid that already exists in the database and add one to it. (In order to keep all userids unique").
    ...
    //This function is called whenever a user logs in in the login servlet.
    ...
    //Deactivate a user's account given their id.
    ...
    //Updates row to display their logout time.
    ...
    //Gets all of a user's accesslog
    ...
    //Updates a user's information, used in the editservlet whenever a user wishes to edit their registration details.
    ...
    //End of DERRICK's Methods
    
    //Start of KIRA's Methods
